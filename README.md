...
- [Background](adapter/queue/client.go#L12) [tasks](user/user_queue/greeter.go#L42)/[workers](cmd/worker/worker.go#L17) with [Asynq](https://github.com/hibiken/asynq)
